...
import { Users, FileText, Calendar, Trophy, BarChart, Clock, Hash, Percent, Gavel, ClipboardCheck, Search, TrendingUp, Sparkles, User, Lightbulb, TrendingDown, Eye } from 'lucide-react';
import './App.css';

// Importando as imagens (Certifique-se de que estes arquivos existam em src/assets/)
...
function App() {
  ...
  // Componente DataCard (Mantido aqui para simplificar a dependência)
  ...
  return (
    <div className="min-h-screen bg-[#0B1016] font-['Poppins',sans-serif] overflow-x-hidden">
      ...
      {/* ==================================================================== */}
      {/* HERO SECTION (Introdução e Menus Maiores) */}
      {/* ==================================================================== */}
      ...
      <section id="nomeacoes" className="py-20 px-4 bg-[#14222E]/80 border-t border-b border-[#0D3A46]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-center mt-12">
            {/* Reuso da imagem, mantendo o slot de imagem aqui */}
